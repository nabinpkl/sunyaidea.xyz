...
export function WalletButton() {
  ...
  return (
    <button
      onClick={() => open()}
      className="ml-1 flex items-center gap-2 px-3 h-8 rounded-sm text-[12px] text-muted-foreground hover:text-foreground hover:bg-foreground/5 transition-colors font-mono tracking-tight"
    >
      <Wallet className="size-3.5 shrink-0" />
